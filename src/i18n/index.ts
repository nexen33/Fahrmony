...
export const translations: Record<LanguageKey, Translations> = {
  'zh-CN': {
    ...
    mediaTab: {
      ...
      rawCardTitle: '音频 App 原始专辑封面',
      rawCardDesc: '开启后将显示原始专辑图，按键颜色会受封面影响',
      lyricsTitle: '车载实时歌词',
      lyricsBadge: 'BETA',
  ...
  'en-US': {
    ...
    mediaTab: {
      ...
      rawCardTitle: 'Original Audio App Album Artwork',
      rawCardDesc: 'Show original cover art; button colors will be affected by the artwork',
  ...
  'de-DE': {
    ...
    mediaTab: {
      ...
      rawCardTitle: 'Originales Albumcover der Audio-App',
      rawCardDesc: 'Originalcover anzeigen; Tastenfarben werden vom Cover beeinflusst',
  ...
  'ja-JP': {
    ...
    mediaTab: {
      ...
      rawCardTitle: 'オーディオAppのオリジナルアルバムカバー',
      rawCardDesc: '有効にするとオリジナルのアルバムアートを表示します（ボタンの色がカバーの影響を受ける場合があります）',
